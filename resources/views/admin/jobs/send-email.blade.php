                ...
                <div class="card-body">
                    ...
                    <div class="row b-b b-t mb-3" style="display: none; background: #fbfbfb;" id="ticket-filters">
                        ...
                        <div class="col-md-12">
                            <form action="" id="filter-form" class="row" >
                                <div class="col-md-4">
                                    <div class="example">
                                        <div class="input-daterange input-group" id="date-range">
                                            <input type="text" class="form-control" id="start-date" placeholder="Data de Inicio" value="" />
                                            <span class="input-group-addon bg-info b-0 text-white p-1">@lang('app.to')</span>
                                            <input type="text" class="form-control" id="end-date" placeholder="Data de Fim" value="" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="address">@lang('menu.skills') : </label>
                                        <select class="select2 select2-multiple" name="skill[]" multiple="multiple"  id="skill" data-style="form-control">
                                            {{--<option value="all">@lang('menu.skills')</option>--}}
                    ...
                    <div class="table-responsive m-t-40">
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                                <th><input type="checkbox" name="select_all_applicants" id="select-all"></th>
                                <th>#</th>
