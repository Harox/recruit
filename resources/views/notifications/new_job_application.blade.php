<a href="{{ route('admin.job-applications.index') }}" class="dropdown-item text-sm">
    ...
    <span class="text-truncate-notify" style="overflow-y: hidden" title="full name"> {{ __('messages.notifications.newJobApplication', ['name' => $notification->data['data']['full_name']]) }}</span>
